        ...
        <div>
            <div class="hero min-h-screen bg-gradient-to-r from-primary to-secondary">
                <div class="hero-content flex-col lg:flex-row-reverse ">
                    <img src={banner} class="max-w-sm lg:w-96rounded-lg shadow-2xl rounded-lg" alt='Car' />
                    <div className='text-white'>
                        <h1 class="text-5xl font-bold">The <span className='text-secondary'>Motocar</span> Junction</h1>
