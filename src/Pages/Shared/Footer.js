        ...
        <footer className="footer footer-center p-10 bg-primary text-primary-content mt-5">
            <div>
                ...
                <p className="font-bold">
                    The MotoCar Junction <br />Providing reliable tech since 1992
                </p>
                <p>Copyright <FontAwesomeIcon className='ms-2 me-2' icon={faCopyright}></FontAwesomeIcon> {new Date().getFullYear()} - All right reserved</p>
            </div>
            <div>
